...
class ChartActivity : AppCompatActivity() {
    ...
    private fun showBarCharts() {
        ...
        // positive
        showBarChartsInternal("No values", chart1, fun ():ArrayList<String> {
    ...
    private fun showBarChartsInternal(title: String, viewGroup: ViewGroup, getXLabels:()->ArrayList<String>, getYLeftItems:()->java.util.ArrayList<AirChartValueItem>) {
